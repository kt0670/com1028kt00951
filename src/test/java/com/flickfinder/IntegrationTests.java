...
class IntegrationTests {
	...
	@Test
	void retrieves_a_list_of_stars_by_movieId() {
	...
	@Test
	void retrieves_a_list_of_movies_by_personId() {
	...
	@Test
	void retrieves_a_list_of_ratings_by_year() {
